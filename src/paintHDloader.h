...
#define STARTUP_TILE_COLS 3u
#define STARTUP_TILE_ROWS 3u
#define STARTUP_TILE_COUNT (STARTUP_TILE_COLS * STARTUP_TILE_ROWS)
#define STARTUP_TOP_MARGIN 7u
#define STARTUP_LEFT_MARGIN 8u
#define STARTUP_TILE_WIDTH 160u
#define STARTUP_TILE_HEIGHT 116u
#define STARTUP_TILE_SPACING_X 8u
#define STARTUP_TILE_SPACING_Y 7u
#define TILE_LABEL_OFFSET_X 0u
#define TILE_LABEL_OFFSET_Y 0u
